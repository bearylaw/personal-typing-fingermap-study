> **Appendix — not the subject of this study.**
>
> This was written when the question was "is there a better layout for a German/Austrian
> keyboard". The actual question turned out to be narrower and more useful: *which finger
> should press which key*, on the QWERTZ letters you already have. That is answered in the
> [main README](../README.md).
>
> The work below is kept because it is real and it uses the same measurement machinery, but
> every figure path and cross-reference in it points at the layout study, not the finger
> study. Read it as background.
...
| [docs/METHOD.md](METHOD.md) | full methodology |
| [docs/REPRODUCE.md](REPRODUCE.md) | every command, and what would falsify the finding |
| [RESULTS.md](../RESULTS-layout.md) | all the tables |
...
Everything is in [`src/`](src/); see [docs/REPRODUCE.md](REPRODUCE.md) for the exact
